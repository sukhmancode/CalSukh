...
import { EditEventTypeAction, eventCreationAction } from "../actions";
    ...
    <div className="h-full w-full flex-1 flex flex-col items-center justify-center">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edit a new appointment type that allows people to book times.
          </CardDescription>
        </CardHeader>
        <form noValidate id={form.id} onSubmit={form.onSubmit} action={action}>
          ...
          <CardFooter className="w-full flex justify-between">
            ...
            <SubmitButtons className="w-full" text="Edit Event Type" />
          </CardFooter>
        </form>
      </Card>
    </div>
